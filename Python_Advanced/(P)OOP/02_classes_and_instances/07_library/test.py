...
user.get_book('J.K.Rowling', 'Harry Potter and the Deathly Hallows', 17, library)
second_user = User(13, 'Peter')
result = second_user.get_book('J.K.Rowling', 'Harry Potter and the Deathly Hallows', 17, library)
print(result)
